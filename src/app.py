...
activities = {
    ...
    "Basketball Club": {
        "description": "Pick-up games and skill development sessions for basketball enthusiasts",
        "schedule": "Wednesdays and Fridays, 4:30 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["ava@mergington.edu", "mia@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore drawing, painting, and mixed media in a collaborative studio space",
    ...
    "Music Ensemble": {
        ...
        "max_participants": 25,
        "participants": ["ethan@mergington.edu", "sophia.m@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        "description": "Hands-on experiments, guest lectures, and science fair preparation",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 22,
